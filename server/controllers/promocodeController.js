...
class promocodeController {
  async getAll(req, res, next) {
    try {
      ...
      return next(ApiError.internal('Ошибка при получении промокодов.'));
    }
  }
  ...
  async getOne(req, res, next) {
    try {
      ...
      return next(ApiError.internal('Ошибка при получении промокода.'));
    }
  }
  ...
  async update(req, res, next) {
    try {
      ...
      return next(ApiError.internal('Ошибка при обновлении промокода.'));
    }
  }
  ...
  async delete(req, res, next) {
    try {
      ...
      return next(ApiError.internal('Ошибка при удалении промокодов.'));
    }
  }
}
